...
import (
	...
	"github.com/vicnoah/ego-component/ewechat/cache"
)
...
type Context struct {
	...
	// activityIdLock 读写锁 同一个AppID一个
	activityIdLock *sync.RWMutex
	...
	// activityIdFunc 自定义获取 activityId 的方法
	activityIdFunc GetActivityIdFunc
}
